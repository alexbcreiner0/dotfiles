...
\begin{frame}{Dynamic Programming vs Greedy Algorithms vs Divide and Conquer}
    \begin{itemize}
        ...
        \item Divide and conquer algorithms can be seen a special case of dynamic programming in which the subproblems are fractional in relation to the original problems, and there is no searching or required or need for memoization. 
