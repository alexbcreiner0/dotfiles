...
\begin{frame}{Dynamic Programming vs Greedy Algorithms vs Divide and Conquer}
    \begin{itemize}
        ...
        \item Most people consider the defining feature of DP to be the the capitalizing on overlapping subproblem structure. If we agree with these people, then we must see divide and conquer as a separate and disjoint programming paradigm from DP, since divide and conquer solutions never have overlapping subproblems. In other words, recursion, DP and divide and conquer should all be seen as separate concepts. 
