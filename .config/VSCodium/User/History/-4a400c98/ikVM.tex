...
\begin{frame}{Steps in Solving a DP}
    \begin{itemize}
        ...
        \item[(3)] (Optional: \textbf{Sort}): If you are going for a bottom-up DP, then you need to identify an ordering to solving the subproblems, inductively building yourself up from the base cases to the answer you're looking for. 
        \item[(4)] Runtime? Sometimes this can be messy, but often times it is simple. The formula is simply 
    \end{itemize}
\end{frame}
