...
\begin{enumerate}
    ...
    \begin{itemize}
        \item[(a)] Before that though, we need to make a few changes/additions to it (I tried to leave you with something which would be perfect for the job in that homework, but my planning was not perfect). Don't worry, this part shouldn't take long.
        \begin{itemize}
