...
\begin{enumerate}
    ...
    \item Consider the following graph:
    Use breadth-first search to find the shortest distance between $A$ and each other node. Include a table demonstrating the work, with a row for each node and a column for each iteration of the loop, containing distance estimates after each pass. Draw the resulting shortest paths tree. 
