...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item[(c)] Perform a depth-first search of the graph, and draw the resulting DFS forest. Start from $A$, and proceed alphabetically whenever there is a choice of which node to move on to.  
    \end{itemize}
    % Longer
