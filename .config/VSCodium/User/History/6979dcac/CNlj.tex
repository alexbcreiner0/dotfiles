...
def d(word):
    ...
    \begin{itemize}
        ...
        \item[(b)] Write the dynamic program in python. I recommend going with a bottom-up implementation, but it does not matter. For the purposes of your own testing, I ended up with the following memo by the end: 
    \begin{minded}{python}
        {'d': False, 'o': False, 'g': False, 's': False, 't': False, 'r': False, 'm': False, 'do': True, 'og': False, 'gs': False, 'st': True, 'to': True, 'or': True, 'rm': False, 'dog': True, 'ogs': False, 'gst': False, 'sto': False, 'tor': True, 'orm': False, 'dogs': True, 'ogst': False, 'gsto': False, 'stor': True, 'torm': False, 'dogst': True, 'ogsto': False, 'gstor': False, 'storm': True, 'dogsto': True, 'ogstor': False, 'gstorm': False, 'dogstor': True, 'ogstorm': False, 'dogstorm': True}
    \end{minted} 
    \end{itemize}
