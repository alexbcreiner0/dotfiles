...
\begin{frame}{NP continued}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item The set of problems which are computable in polynomial time by a nondeterministic Turing machine (take my class in the spring if you want to know what this means).
        \end{itemize}
    \end{itemize}
\end{frame}
