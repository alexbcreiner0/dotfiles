...
\begin{frame}{NP continued}
    \begin{itemize}
        ...
        \item This is one way to formulate the class $\mathbf{NP}$: The set of problems such that you can \emph{check to see if you have the right answer} in polynomial time. Any problem for which you could efficiently confirm or deny an answer once you have one would be helped in the same way by a magic guessing machine. 
    \end{itemize}
\end{frame}
