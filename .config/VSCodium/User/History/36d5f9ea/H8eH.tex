...
\begin{frame}{The question}
    \begin{itemize}
        ...
        \item This open problem is one of six remaining \href{https://en.wikipedia.org/wiki/Millennium_Prize_Problems}{Millenium Prize Problems}, and has a one million dollar bounty. Of those problems, $\mathbf{P}$ vs $\mathbf{NP}$ is by far the easiest to understand. 
    \end{itemize}
\end{frame}
