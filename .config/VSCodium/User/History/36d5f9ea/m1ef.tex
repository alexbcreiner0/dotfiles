...
\begin{frame}{NP continued}
    \begin{itemize}
        ...
        \end{itemize}
        \item Turning back to the theoretical definition, the various computation paths defined by a nondeterministic Turing machine correspond to are one in the same as the computation that follows from the various guesses being made. A NTM is defined to say yes iff there exists a path in it's computation tree which halts in acceptance. 
